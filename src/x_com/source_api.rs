...
impl std::fmt::Debug for EmptyRequest {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("EmptyRequest").finish()
    }
}
...
impl RequestMessage for EmptyRequest {
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        self.cached_size.set(my_size as u32);
        my_size
...
impl SimAccountStatus {
    pub fn from_i32(value: i32) -> Option<SimAccountStatus> {
        match value {
            0 => Some(Self::SimAccountStatusUnknown),
            1 => Some(Self::SimAccountStatusActive),
            2 => Some(Self::SimAccountStatusPaused),
            3 => Some(Self::SimAccountStatusArchived),
            _ => None,
        }
    }
}
...
impl SimAccountAuditAction {
    pub fn from_i32(value: i32) -> Option<SimAccountAuditAction> {
        match value {
            0 => Some(Self::SimAccountAuditActionUnknown),
            1 => Some(Self::SimAccountAuditActionCreated),
            2 => Some(Self::SimAccountAuditActionUpdated),
            3 => Some(Self::SimAccountAuditActionStatusChanged),
            4 => Some(Self::SimAccountAuditActionBindingChanged),
            5 => Some(Self::SimAccountAuditActionRiskLimitsChanged),
            _ => None,
        }
    }
}
